...
namespace SGR
{
    public partial class db_a5a7f4_li4sgrContext : DbContext
    {
        public db_a5a7f4_li4sgrContext()
        {
        }

        public db_a5a7f4_li4sgrContext(DbContextOptions<db_a5a7f4_li4sgrContext> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseMySql("server=mysql5017.site4now.net;uid=a5a7f4_li4sgr;pwd=liquatrosgr4;database=db_a5a7f4_li4sgr", x => x.ServerVersion("5.6.26-mysql"));
            }
        }
